...
public class DiagnosticoViewDAO {
    ...
    public List<DiagnosticoView> buscarTodos() throws Exception {
    	...
    	try {
			...
			"       ON VW_DIAGNOSTICO.ID_COMUNIDADE = C.ID_COMUNIDADE " +
			"    WHERE C.SITUACAO = 'A' " 
			);
    ...
    public List<DiagnosticoView> buscarPorPeriodo(String dtInicio, String dtFim) throws Exception {
    	PreparedStatement stmt = null;
    	ResultSet rs = null;
    	List<DiagnosticoView> lista = new ArrayList<>();
    	try {
    		stmt = connection.prepareStatement(
    				...
    				"LEFT JOIN TB_COMUNIDADE C " +
					"      ON VW_DIAGNOSTICO.ID_COMUNIDADE = C.ID_COMUNIDADE " +
					"   WHERE VW_DIAGNOSTICO.DATA >= ? " +
					"     AND VW_DIAGNOSTICO.DATA <= ? " +
					"     AND C.SITUACAO = 'A' "
			);
...
//    			diagnosticoView.add(rs.getString("OBS_GERAIS"));
    ...
    public List<DiagnosticoView> buscarPorComunidade(String idComunidade) throws Exception {
    	PreparedStatement stmt = null;
    	ResultSet rs = null;
    	List<DiagnosticoView> lista = new ArrayList<>();
    	try {
    		stmt = connection.prepareStatement(
					"SELECT VW_DIAGNOSTICO.* " +
					"  FROM VW_DIAGNOSTICO " +
					" WHERE VW_DIAGNOSTICO.ID_COMUNIDADE = ? "
			);
	...
	public List<DiagnosticoView> buscarPorPeriodoComunidade(String dtInicio, String dtFim, String idComunidade)
			throws Exception {
    	PreparedStatement stmt = null;
    	ResultSet rs = null;
    	List<DiagnosticoView> lista = new ArrayList<>();
    ...
    public List<DiagnosticoView> buscarPorEquipe(String idEquipe) throws Exception {
    	PreparedStatement stmt = null;
    	ResultSet rs = null;
    	List<DiagnosticoView> lista = new ArrayList<>();
    	try {
    		stmt = connection.prepareStatement(
					...
					"LEFT JOIN TB_COMUNIDADE C " +
					"       ON VW_DIAGNOSTICO.ID_COMUNIDADE = C.ID_COMUNIDADE " +
					"    WHERE VW_DIAGNOSTICO.ID_EQUIPE = ? " +
					"      AND C.SITUACAO = 'A' "
			);
	...
	public List<DiagnosticoView> buscarPorPeriodoEquipe(String dtInicio, String dtFim, String idEquipe)
			throws Exception {
    	PreparedStatement stmt = null;
    	ResultSet rs = null;
    	List<DiagnosticoView> lista = new ArrayList<>();
