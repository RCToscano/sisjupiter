        ...
        try {
            ...
            //Excel Totais
	            ...
	            try {
		        	...
		        	String nomeArquivo = "Relatorio_Equipe_"+Auxiliar.dataAtual()+".xlsx";
            ...
            //Excel com Dianosticos por Equipe
            else if (relat.equals("excelEquipe")) {
            	try {
            		String idEquipe = req.getParameter("equipe");
            		
            		connection = ConnectionFactory.getConnection();
					RelEquipeDAO equipeDAO = new RelEquipeDAO(connection);
					List<RelEquipe> listaEquipe = equipeDAO.qtdeExecucaoPorEquipe(idEquipe);
            		...
            		//Diagnosticos
		        	DiagnosticoViewDAO viewDAO = new DiagnosticoViewDAO(connection);
            		List<DiagnosticoView> listaView = viewDAO.buscarPorEquipe(idEquipe);
            		...
            		String nomeArquivo = "Relatorio_Equipe"+idEquipe+"_"+Auxiliar.dataAtual()+".xlsx";
            ...
            //Excel Totais por Periodo
            	...
            	try {
		        	...
		        	connection = ConnectionFactory.getConnection();
		        	RelEquipeDAO comunidadeDAO = new RelEquipeDAO(connection);
		        	List<RelEquipe> listaEquipe = comunidadeDAO.qtdeExecucaoPeriodo(dtInicio, dtFim);
            ...
            //Excel Periodo com Dianosticos por Equipe
            else if (relat.equals("excelEquipePeriodo")) {
            	try {
            		SimpleDateFormat formatoBanco = new SimpleDateFormat("yyyy-MM-dd");
            		SimpleDateFormat formatoData = new SimpleDateFormat("dd/MM/yyyy");
            		...
            		connection = ConnectionFactory.getConnection();
            		RelEquipeDAO comunidadeDAO = new RelEquipeDAO(connection);
					List<RelEquipe> listaEquipe = comunidadeDAO.qtdeExecucaoPeriodoEquipe(dtInicio, dtFim, idEquipe);
            		...
            		//Diagnosticos
            		DiagnosticoViewDAO viewDAO = new DiagnosticoViewDAO(connection);
					List<DiagnosticoView> listaView = viewDAO.buscarPorPeriodoEquipe(dtInicio, dtFim, idEquipe);
