    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (relat.equals("consultar")) {
            	...
            	diagnostico.setCategoria1(Auxiliar.converteInteger(req.getParameter("checkTpImovelResidencia")));
            	diagnostico.setCategoria2(Auxiliar.converteInteger(req.getParameter("checkTpImovelComercio")));
            	diagnostico.setCategoria3(Auxiliar.converteInteger(req.getParameter("checkTpImovelIndustria")));
            	diagnostico.setCategoria4(Auxiliar.converteInteger(req.getParameter("checkTpImovelPublica")));
            	...
            	diagnostico.setMeioTransp1(Auxiliar.converteInteger(req.getParameter("checkTransporteCarro")));
            	diagnostico.setMeioTransp2(Auxiliar.converteInteger(req.getParameter("checkTransporteOnibus")));
            	diagnostico.setMeioTransp3(Auxiliar.converteInteger(req.getParameter("checkTransporteTrem")));
            	diagnostico.setMeioTransp4(Auxiliar.converteInteger(req.getParameter("checkTransporteMetro")));
            	diagnostico.setMeioTransp5(Auxiliar.converteInteger(req.getParameter("checkTransporteTaxi")));
            	...
            	diagnostico.setTratCancer(Auxiliar.converteInteger(req.getParameter("checkCancer")));
            	diagnostico.setTratHansen(Auxiliar.converteInteger(req.getParameter("checkHanseniase")));
            	diagnostico.setTratMental(Auxiliar.converteInteger(req.getParameter("checkMental")));
            	diagnostico.setTratEscler(Auxiliar.converteInteger(req.getParameter("checkEsclerose")));
            	diagnostico.setTratParal(Auxiliar.converteInteger(req.getParameter("checkParalisia")));
            	diagnostico.setTratHepat(Auxiliar.converteInteger(req.getParameter("checkHepatica")));
            	diagnostico.setTratCardiac(Auxiliar.converteInteger(req.getParameter("checkCardiaca")));
            	diagnostico.setTratParkins(Auxiliar.converteInteger(req.getParameter("checkParkinson")));
            	diagnostico.setTratRenal(Auxiliar.converteInteger(req.getParameter("checkRenais")));
            	diagnostico.setTratOutro(Auxiliar.converteInteger(req.getParameter("outroDoenca")));
            	diagnostico.setAmebiase(Auxiliar.converteInteger(req.getParameter("checkAmebiase")));
            	diagnostico.setAmebiaseMemb(req.getParameter("amebiase"));
            	diagnostico.setGastroent(Auxiliar.converteInteger(req.getParameter("checkGastroenterite")));
            	diagnostico.setGastroentMemb(req.getParameter("gastroenterite"));
            	diagnostico.setGiardiase(Auxiliar.converteInteger(req.getParameter("checkGiardiase")));
