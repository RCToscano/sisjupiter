            ...
            <form id="defaultForm" data-toggle="validator" class="navbar-form navbar-right" role="form" action="Login?r=login" method='POST'>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input id="email" type="email" class="form-control" name="email" value="" placeholder="Email" data-toggle="tooltip" data-placement="bottom" title="${loginErro}" required>
                    </div>
                </div> 
                <div class="form-group">                   
                    <div class="input-group">
